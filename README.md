...
```bash
npm install --save-dev @oliviac-tutorial-demo/frontend-config eslint prettier
```
...
```javascript
import config from '@oliviac-tutorial-demo/frontend-config/eslint';
...
```javascript
import config from '@oliviac-tutorial-demo/frontend-config/prettier';
...
frontend-configs/
├── packages/
│   └── configs/              # @oliviac-tutorial-demo/frontend-config
